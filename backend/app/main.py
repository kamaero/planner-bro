...
from app.api.v1 import auth, projects, tasks, users, org, temp_assignees, login_events, notifications, vault, chat, analytics, email_actions, ai_analysis, changelog, reports
...
app.include_router(temp_assignees.router, prefix="/api/v1")
app.include_router(login_events.router, prefix="/api/v1")
