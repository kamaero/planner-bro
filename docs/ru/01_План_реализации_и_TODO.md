...
- [ ] Зафиксировать единый словарь статусов проектов.
- [ ] Зафиксировать единый словарь статусов задач.
- [ ] Зафиксировать единый словарь приоритетов.
- [ ] Зафиксировать матрицу ролей и visibility scope.
- [ ] Зафиксировать отдельные permissions: `can_delete`, `can_import`, `can_bulk_edit`, `can_manage_team`.
- [ ] Зафиксировать контракт realtime / notification events.
